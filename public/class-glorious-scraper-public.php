 ...
 * @subpackage Glorious_Scraper/public
 */
...
class Glorious_Scraper_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/glorious-scraper-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/glorious-scraper-public.js', array( 'jquery' ), $this->version, true );
	 ...
	 *
	 * Shortcode can take attributes like [glorious-scraper-shortcode attribute='123']
	 * Shortcodes can be enclosing content [glorious-scraper-shortcode attribute='123']custom content[/glorious-scraper-shortcode].
	 *
